...
<html class="wide wow-animation" lang="en">
  <head>
    ...
    <link rel="icon" href="images/fig_church.png" type="image/x-icon">
                ...
                <ul class="list-inline list-inline-md">
                  <li>
                    <div class="unit unit-spacing-xs align-items-center">
                      ...
                      <div class="unit-left"><span class="icon fa fa-facebook-f"></span></div>
                      <div class="unit-body"><a href="https://www.facebook.com/FIGDallas/" target="_blank">FIG USA Facebook</a></div>
                    </div>
                  </li>
                  <li>
                    <div class="unit unit-spacing-xs align-items-center">
                      <div class="unit-left"><span class="icon text-middle mdi-map-marker mdi"></span></div>
                      <div class="unit-body"><a href="https://maps.app.goo.gl/Wrg1ZGKV9J8oL9Rp8" target="_blank">1750 N Collins Blvd Ste 103, Richardson, TX 75080</a></div>
                    </div>
                  </li>
                </ul>
                <ul class="social-list">
                  <li><a href="https://www.youtube.com/@figministries-dallastx5963" target="_blank"><span class="icon fa fa-youtube-play"></span></a></li>
                  <!-- <li><a href="#"><span class="icon fa fa-twitter"></span></a></li> -->
                  <li><a href="https://www.facebook.com/FIGDallas/" target="_blank"><span class="icon fa fa-facebook-f"></span></a></li>
              ...
              <div class="rd-navbar-main">
                ...
                <div class="rd-navbar-panel">
                  ...
                  <div class="rd-navbar-brand">
                    <!--Brand--><a class="brand" href="index.html"><img class="brand-logo-dark" src="images/fig_church.png" alt="" width="94" height="27"/><img class="brand-logo-light" src="images/logo-default-189x54.png" alt="" width="94" height="27"/></a>
                  </div>
                </div>
                <div class="rd-navbar-main-element">
                  <div class="rd-navbar-nav-wrap">
                    <ul class="rd-navbar-nav">
                      ...
                      <li class="rd-nav-item"><a class="rd-nav-link" href="ministries.html">Give</a>
                      </li>
                    </ul>
                  </div>
                </div>
        ...
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-xl-8 col-lg-10">
                <div class="pre-title wow fadeInLeft" data-wow-delay=".1s">Welcome to FAITH IN GOD MINISTRIES</div>
                <h2 class="wow fadeInRight" data-wow-delay=".2s">Bring them in, Train them and Release them</h2>
                <div class="pre-title wow fadeInLeft" data-wow-delay=".1s">-Our Motto-</div>
                <p class="text-sm wow fadeInUp" data-wow-delay=".3s"> Faith In God Ministries International stands on the world scene to proclaim the Gospel of the kingdom, to establish believers in God’s eternal word and release them to their age-long purposes.</p>

                <a class="shadow btn btn-icon btn-icon-right btn-primary btn-svg offset-xl-55 wow fadeInUp" href="#" data-wow-delay=".3s"><span class="svg-icon">
                    ...
                    </svg></span><span>More about us</span>
                </a>
            </div>
          </div>
        </div>
      ...
      <section class="section section-lg bg-default">
        <div class="container">
          <div class="row row-30 align-items-center">
            <div class="col-lg-6 p-xl-0 wow fadeInLeft"><img src="images/ophti/charity.webp" alt="" width="660" height="495"/>
            </div>
            <div class="col-lg-6 inset-left-110">
              <div class="pre-title wow fadeInRight" data-wow-delay=".1s">Operation Hope Trust USA</div>
              <h2 class="wow fadeInRight" data-wow-delay=".2s">Sharing God’s love through charity</h2>
              <p class="wow fadeInRight" data-wow-delay=".3s">At Operation Hope Trust International (OPHTI), our mission is to empower underprivileged communities and alleviate poverty through sustainable and holistic solutions. We are dedicated to fostering positive change by addressing the root causes of poverty, promoting education, enhancing livelihoods, and fostering community development.</p>
                <a class="shadow btn btn-icon btn-icon-right btn-primary btn-svg offset-xl-50 wow fadeInUp" href="https://ophti.org/" target="_blank" data-wow-delay=".3s"><span class="svg-icon">
                  <svg xmlns="http://www.w3.org/2000/svg" width="18" height="10" viewbox="0 0 18 10" fill="#fff">
                    <path d="M13 10V6H0V4H13V0L18 5L13 10Z" fill=""></path>
                  </svg></span><span>Read more</span>
                </a>
            </div>
          </div>
        </div>
          ...
          <div class="row row-30 align-items-center flex-column-reverse flex-lg-row">
            <div class="col-lg-6 inset-right-110">
              ...
              <p class="wow fadeInLeft" data-wow-delay=".3s">
                Biblical teaching on giving yields a bountiful harvest in our lives when it is practiced. Join the amazing community of our church's supporters by thinking about making a donation today. The world, our neighbourhood, and this church are all benefiting from your donation.
              </p>
              
              <a class="shadow btn btn-primary offset-xl-50 wow fadeInUp" href="#" data-wow-delay=".3s">Donate now</a>
            </div>
            <div class="col-lg-6 p-xl-0 wow fadeInRight"><img src="images/hero/giving.png" alt="" width="660" height="495"/>
            </div>
          </div>
        </div>
      </section>
                      ...
                      <div class="row justify-content-center">
                        <div class="col-xl-10 p-xl-0">
                          <div class="row justify-content-center row-20 align-items-center flex-column flex-md-row">
                            <div class="col-lg-3 p-xl-0"><img src="images/hero/hero_image_3_resized.png" alt="" width="280" height="349"/>
                            </div>
                            <div class="col-lg-9 inset-left-110">
                              <div class="h3">“Refuse to remain in the stipulated areas of anything.<span class="text-italic accent-block">Go an extra mile,</span> that is where the profit is.”</div>
                              <div class="author">Archbishop Dr. A. Gurupira & Apostle M. Gurupira</div>
                              <div class="author-position">Our Founder</div>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="row justify-content-center">
                        <div class="col-xl-10 p-xl-0">
                          <div class="row justify-content-center align-items-center flex-column flex-md-row row-20">
                            <div class="col-lg-3 p-xl-0"><img src="images/hero/hero_image_2_resized.jpg" alt="" width="280" height="349"/>
                            </div>
                            <div class="col-lg-9 inset-left-110">
                              <div class="h3">“Stop asking God to Bless what you're doing,<span class="text-italic accent-block">But learn to do what God is Blessing.</span>That is his perfect will.”</div>
                              <div class="author">Pastor Cleo</div>
                              <div class="author-position">Our Pastor</div>
                            </div>
                          </div>
                        </div>
                      </div>
        ...
        <div class="container">
          ...
          <div class="row row-narrow-50 row-40 row-xl">
            <div class="col-lg-6 wow fadeInUp" data-wow-delay=".3s">
              <div class="thumbnail-classic"><a class="thumbnail-classic__media" href="#"><img src="images/hero/home_church.png" alt="" width="610" height="458"/></a>
                <h3><a href="#">F.I.G Ministries Dallas</a></h3><a class="location" href="https://maps.app.goo.gl/Wrg1ZGKV9J8oL9Rp8" target="_blank"><span class="icon mdi-map-marker mdi"></span>1750 N Collins Blvd Ste 103, Richardson, TX 75080</a>
              </div>
            </div>
            <div class="col-lg-6 wow fadeInUp" data-wow-delay=".3s">
              <div class="thumbnail-classic"><a class="thumbnail-classic__media" href="#"><img src="images/hero/fig_dallas.png" alt="" width="610" height="458"/></a>
                <h3><a href="#">F.I.G Ministries World Wide</a></h3><a class="location" href="#"><span class="icon mdi-map-marker mdi"></span>World Wide</a>
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="row justify-content-xl-between row-40 justify-content-lg-center">
              ...
              <div class="col-lg-5 inset-right-100 wow fadeInRight" data-wow-delay=".3s">
                ...
                <ul class="contact-list">
                  <li>1750 N Collins Blvd Ste 103, Richardson, TX 75080 Questions? Please write us at: <a class="link-secondary" href="mailto:#">faithingodusa@gmail.com</a></li>
          ...
          <div class="container">
            <div class="row row-xl-40">
              ...
              <div class="col-12 wow fadeInUp" data-wow-delay=".4s">
                <p class="rights"><span>&copy;&nbsp; </span><span class="copyright-year"></span><span>&nbsp;</span><span>F.I.G Ministries</span><span>.&nbsp;</span><span>All Rights Reserved.</span></p>
              </div>
            </div>
          </div>
        </div>
